...
def dynamic_decode(decoder,win,hidden,
  ...
  with variable_scope.variable_scope(scope, "decoder") as varscope:
    ...
    initial_finished, initial_inputs, initial_state,ini_state = decoder.initialize()
    ...
    def condition(unused_time, unused_outputs_ta, unused_state, unused_inputs,
                  finished, unused_sequence_lengths,full):
      return math_ops.logical_not(math_ops.reduce_all(finished))

    def body(time, outputs_ta, state, inputs, finished, sequence_lengths,full):
      ...
      (next_outputs, decoder_state, next_inputs,
       decoder_finished,decoder_state_full) = decoder.step(time, inputs, state,full)
      ...
      return (time + 1, outputs_ta, next_state, next_inputs, next_finished,
              next_sequence_lengths,decoder_state_full)
  ...
  return final_outputs, final_state, final_sequence_lengths,all_states_dec